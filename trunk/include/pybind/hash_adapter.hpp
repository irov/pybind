...
namespace pybind
{
    ...
    {
	public:
		virtual size_t hash( PyObject * _obj, void * _self, const class_type_scope_ptr & _scope ) = 0;
	};
    //////////////////////////////////////////////////////////////////////////
	...
	public:
		size_t hash( PyObject * _obj, void * _self, const class_type_scope_ptr & _scope ) override
		{
