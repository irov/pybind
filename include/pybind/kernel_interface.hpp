...
namespace pybind
{
    ...
    public:
        ...
        virtual bool get_traceback_top( char * const _filename, size_t _maxlenfilename, char * const _function, size_t _maxlenfunction, uint32_t * _lineno ) = 0;
        virtual bool get_traceback( char * _buffer, size_t _maxlen, bool _append ) = 0;
        ...
        virtual void set_error( error_type_e _type, const char * _message ) = 0;
        ...
        virtual PyObject * ptr_integer( int64_t _value ) = 0;
        ...
        virtual PyObject * unicode_encode_utf8( PyObject * _unicode ) = 0;
