...
namespace pybind
{
	...
	struct method_proxy_args_call_ret_impl
	{
		...
		{
			PyObject * py_result = (detail::return_operator_t)method_proxy_args_call_impl<P, C, F, Ret, f_info::arity>::call( _proxy, _obj, f, _arg );
	...
	struct method_proxy_args_call_ret_impl<P,C,F,void>
	{
		...
		static PyObject * call( P * _proxy, C * _obj, F f, PyObject * _arg )
		{
			method_proxy_args_call_impl<P,C,F,void,f_info::arity>::call( _proxy, _obj, f, _arg );
	...
	struct method_proxy_args_call
	{
		...
		static PyObject * call( P * _proxy, C * _obj, F f, PyObject * _arg )
		{
			...
			PyObject * ret = method_proxy_args_call_ret_impl<P,C,F,typename f_info::ret_type>::call( _proxy, _obj, f, _arg );
