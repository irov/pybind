...
namespace pybind
{
	...
	struct method_args_call_ret_impl
	{
		...
		{
			PyObject * py_result = detail::return_operator_t( _kernel, method_args_call_impl<C, F, Ret, f_info::arity>::call( _kernel, _obj, f, _arg ) );
	...
	struct method_args_call
	{
		...
		static PyObject * call( kernel_interface * _kernel, C * _self, F f, PyObject * _arg )
		{
			...
			PyObject * py_ret = method_args_call_ret_impl<C,F,typename f_info::ret_type>::call( _kernel, _self, f, _arg );
