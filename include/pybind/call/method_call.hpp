...
namespace pybind
{
    ...
    struct method_call_ret_impl
    {
        ...
        {
            PyObject * py_result = detail::return_operator_t( _kernel, method_call_impl<C, F, Ret>::call( _kernel, _obj, f, _arg, std::make_integer_sequence<size_t, Arity>() ) );
    ...
    struct method_call_ret_impl<C, F, Arity, void>
    {
        static PyObject * call( kernel_interface * _kernel, C * _obj, F f, PyObject * _arg )
        {
            method_call_impl<C, F, void>::call( _kernel, _obj, f, _arg, std::make_integer_sequence<size_t, Arity>() );
    ...
    struct method_call
    {
        static PyObject * call( kernel_interface * _kernel, C * _self, F f, PyObject * _arg )
        {
            ...
            static_assert(f_info::method == true, "[pybind] method bind requires a method");
            ...
            PyObject * py_ret = method_call_ret_impl<C, F, f_info::arity, typename f_info::ret_type>::call( _kernel, _self, f, _arg );
