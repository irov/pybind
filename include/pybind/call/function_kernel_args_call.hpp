...
namespace pybind
{
    ...
    struct function_kernel_args_call_ret_impl
    {
        ...
        {
            PyObject * py_result = detail::return_operator_t( _kernel, function_kernel_args_call_impl<F, Ret>::call( _kernel, f, _arg, std::make_integer_sequence<size_t, Arity>() ) );
    ...
    struct function_kernel_args_call_ret_impl<F, Arity, void>
    {
        static PyObject * call( kernel_interface * _kernel, F f, PyObject * _arg )
        {
            function_kernel_args_call_impl<F, void>::call( _kernel, f, _arg, std::make_integer_sequence<size_t, Arity>() );
    ...
    struct function_kernel_args_call
    {
        static PyObject * call( kernel_interface * _kernel, F f, PyObject * _arg )
        {
            ...
            static_assert(f_info::method == false, "[pybind] function kernel args bind requires a function");
            static_assert(f_info::arity >= 2, "[pybind] function kernel args bind requires kernel and args arguments");
            ...
            {
                pybind::throw_exception( "invalid function kernel args call. Args is not equal %u < %u (%s)"
                    , arg_size + 2
                    , fn_arity
