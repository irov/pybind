...
namespace pybind
{
    ...
    struct method_proxy_call_ret_impl
    {
        ...
        {
            PyObject * py_result = detail::return_operator_t( _kernel, method_proxy_call_impl<P, C, F, Ret>::call( _kernel, _proxy, _obj, f, _arg, std::make_index_sequence<Arity>() ) );
    ...
    struct method_proxy_call_ret_impl<P, C, F, Arity, void>
    {
        static PyObject * call( kernel_interface * _kernel, P * _proxy, C * _obj, F f, PyObject * _arg )
        {
            method_proxy_call_impl<P, C, F, void>::call( _kernel, _proxy, _obj, f, _arg, std::make_index_sequence<Arity>() );
