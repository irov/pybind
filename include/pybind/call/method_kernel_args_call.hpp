...
namespace pybind
{
    ...
    struct method_kernel_args_call_ret_impl
    {
        ...
        {
            PyObject * result = detail::return_operator_t( _kernel, method_kernel_args_call_impl<C, F, Ret>::call( _kernel, _obj, f, _arg, std::make_integer_sequence<size_t, Arity>() ) );
    ...
    struct method_kernel_args_call_ret_impl<C, F, Arity, void>
    {
        static PyObject * call( kernel_interface * _kernel, C * _obj, F f, PyObject * _arg )
        {
            method_kernel_args_call_impl<C, F, void>::call( _kernel, _obj, f, _arg, std::make_integer_sequence<size_t, Arity>() );
    ...
    struct method_kernel_args_call
    {
        static PyObject * call( kernel_interface * _kernel, C * _self, F f, PyObject * _arg )
        {
            ...
            static_assert(f_info::method == true, "[pybind] method kernel args bind requires a method");
            static_assert(std::is_convertible<C *, typename f_info::class_type *>::value == true, "[pybind] method class type is incompatible");
            static_assert(f_info::arity >= 2, "[pybind] method kernel args bind requires kernel and args arguments");
            ...
            {
                pybind::throw_exception( "invalid method kernel args call. Args is not equal %d < %d (%s)"
                    , arg_size + 2
                    , fn_arity
