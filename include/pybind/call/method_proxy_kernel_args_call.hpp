...
namespace pybind
{
    ...
    struct method_proxy_kernel_args_call
    {
        static PyObject * call( kernel_interface * _kernel, P * _proxy, C * _obj, F f, PyObject * _arg )
        {
            ...
            static_assert(f_info::method == true, "[pybind] method proxy kernel args bind requires a method");
            static_assert(std::is_convertible<P *, typename f_info::class_type *>::value == true, "[pybind] method proxy class type is incompatible");
            static_assert(f_info::arity >= 3, "[pybind] method proxy kernel args bind requires kernel, object and args arguments");
            ...
            PyObject * ret = method_proxy_kernel_args_call_ret_impl<P, C, F, f_info::arity - 3, typename f_info::ret_type>::call( _kernel, _proxy, _obj, f, _arg );
