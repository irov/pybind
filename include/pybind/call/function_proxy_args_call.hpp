...
namespace pybind
{
    ...
    struct function_proxy_args_call_ret_impl
    {
        ...
        {
            PyObject * result = detail::return_operator_t( _kernel, function_proxy_args_call_impl<F, P, Ret>::call( _kernel, _proxy, f, _arg, std::make_integer_sequence<size_t, Arity>() ) );
    ...
    struct function_proxy_args_call_ret_impl<F, P, Arity, void>
    {
        static PyObject * call( kernel_interface * _kernel, P * _proxy, F f, PyObject * _arg )
        {
            function_proxy_args_call_impl<F, P, void>::call( _kernel, _proxy, f, _arg, std::make_integer_sequence<size_t, Arity>() );
    ...
    struct function_proxy_args_call
    {
        static PyObject * call( kernel_interface * _kernel, P * _proxy, F f, PyObject * _arg )
        {
            ...
            static_assert(f_info::method == false, "[pybind] function proxy args bind requires a function");
            static_assert(f_info::arity >= 2, "[pybind] function proxy args bind requires proxy and args arguments");
            static_assert(std::is_convertible<P *, typename f_info::template iterator_param<0>>::value == true, "[pybind] function proxy argument type is incompatible");
            ...
            {
                pybind::throw_exception( "invalid function proxy args call. Args is not equal %u < %u (%s)"
                    , arg_size + 2
                    , fn_arity
