...
#	define DEBUG_PYBIND_NOTIFY_BEGIN_BIND_CALL( Kernel, ClassName, FunctionName, Args, Kwds )\
	pybind::notify_begin_bind_call( Kernel, ClassName, FunctionName, Args, Kwds )
#	define DEBUG_PYBIND_NOTIFY_END_BIND_CALL( Kernel, ClassName, FunctionName, Args, Kwds )\
	pybind::notify_end_bind_call( Kernel, ClassName, FunctionName, Args, Kwds )
#else
#	define DEBUG_PYBIND_NOTIFY_BEGIN_BIND_CALL( Kernel, ClassName, FunctionName, Args, Kwds )
#	define DEBUG_PYBIND_NOTIFY_END_BIND_CALL( Kernel, ClassName, FunctionName, Args, Kwds )
#endif
