...
namespace pybind
{
	...
	{
	public:
		static class_type_scope_ptr create_new_type_scope( uint32_t _info, const char * _name, void * _user, const class_new_interface_ptr & _pynew, const class_destroy_interface_ptr & _pydestructor, uint32_t _pod );
