...
void test_tuple( uint32_t i )
{
	pybind::tuple pp0 = pybind::make_tuple_t();
	pybind::tuple pp1 = pybind::make_tuple_t( 4234 + i );
	pybind::tuple pp2 = pybind::make_tuple_t( 4234 + i, 434 + i );
	pybind::tuple pp3 = pybind::make_tuple_t( 4234 + i, 434 + i, 65465464 + i * 2 );
...
{
	return (int)(pybind::extract<float>( _obj ) +j);
}
...
void test_function_decl()
{ 
	pybind::def_function( "test_function_1", &test_function_1 );
	pybind::def_function( "test_function_2", &test_function_2 );
	pybind::def_function( "test_function_3", &test_function_3 );
	pybind::def_function( "test_function_4", &test_function_4 );
	pybind::def_function( "test_function_5", &test_function_5 );	
}
