...
{
    //////////////////////////////////////////////////////////////////////////
    dict_iterator::dict_iterator( PyObject * _obj )
        : m_obj(_obj)
        , m_pos(0)
        , m_key( nullptr )
        , m_value( nullptr )
    ...
    //////////////////////////////////////////////////////////////////////////
    dict_iterator::dict_iterator( PyObject * _obj, t_dict_iterator_end_tag )
        : m_obj(_obj)
        , m_pos((size_t)(-1))
        , m_key(nullptr)
        , m_value( nullptr )
    ...
    {
        return detail::extract_operator_t( m_key );
    }
    //////////////////////////////////////////////////////////////////////////
    detail::extract_operator_t dict_iterator::value() const
    {
        return detail::extract_operator_t( m_value );
    }
}
